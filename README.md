...
Reutilizar la practica 1, implementar el algoritmo de entrenamiento y usarla en la actividad anterior.

Puntos extra: mostrar la  precisión, matriz de confusión y f1_score.
